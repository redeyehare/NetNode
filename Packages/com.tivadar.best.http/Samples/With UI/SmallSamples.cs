...
{
    /// <summary>
    /// 可以在一个方法和一个附加回调中实现的小型示例集合。请求结果将记录/显示在UI上。
    /// </summary>
...
#pragma warning restore
        ...
        void CachedForNSeconds()
        {
            ...
            // 通过调用 /cache/30，服务器将发送缓存头，通知客户端内容可缓存并在30秒内有效。
            // 在30秒内，对相同URI的请求应从本地缓存返回内容。
...
#pragma warning restore
        ...
        /// <summary>
        /// HTTPRequest 的简单回调，当请求成功或失败时调用。
        /// </summary>
        /// <param name="req">原始的 HTTPRequest 实例。</param>
        /// <param name="resp">HTTPResponse 对象的引用，如果发生错误则为 null。</param>
